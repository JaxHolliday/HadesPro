...
namespace HadesPro.Services
{
    public class SeedService
    {
        ...
        private async Task SeedRolesAsync()
        {
            ...
            var adminRole = _appSettings.HadesProSettings.DefaultCredentials.Role;
        ...
        private async Task SeedUsersAsync()
        {
            ...
            var credentials = _appSettings.HadesProSettings.DefaultCredentials;
        ...
        private async Task SeedCollections()
        {
            ...
            {
                Name = _appSettings.HadesProSettings.DefaultCollection.Name,
                Description = _appSettings.HadesProSettings.DefaultCollection.Description
            });
