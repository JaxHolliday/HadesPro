...
namespace HadesPro.Services
{
    public class TMDBMappingService : IDataMappingService
    {
        ...
        {
            var backdropPath = $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.HadesProSettings.DefaultBackdropSize}/{path}";
        ...
        {
            var posterPath = $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.HadesProSettings.DefaultPosterSize}/{path}";
        ...
        private string BuildCastImage(string profilePath)
        {
            if (string.IsNullOrEmpty(profilePath))
                return _appSettings.HadesProSettings.DefaultCastImage;

            return $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.HadesProSettings.DefaultPosterSize}/{profilePath}";
        }
