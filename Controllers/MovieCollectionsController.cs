...
namespace HadesPro.Controllers
{
    public class MovieCollectionsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id)
        {
            ...
            //view and managee movies in particular collections
            ...
            //list box in the view to choose as many records as you want 
        ...
        public async Task<IActionResult> Index(int id, List<int> idsInCollection)
        {
            ...
            {
                // go thru all id's in collection thrue loop
                int index = 1;
            ...
            // returneds to index followed by "inferred" member
